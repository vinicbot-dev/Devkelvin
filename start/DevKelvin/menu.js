...
const menuPresets = {
    preset1: [
        'header', 'ai', 'audio', 'cmdTool', 'convert', 'download', 'education', 
    ...
    preset2: [
        ...
        'ephoto', 'other', 'helpers', 'religion', 'sports', 'education' // Added education
    ],
    preset3: [
        'header', 'features', 'ai', 'download', 'audio', 'convert', 'image',
        'group', 'owner', 'reaction', 'fun', 'search', 'ephoto',
        'cmdTool', 'other', 'helpers', 'religion', 'sports', 'education' // Added education
    ],
    preset4: [
